...
const SignIn: React.FC = () => {
  ...
  return (
    <>
      {error && (
        <div
          className="flex items-center p-4 mb-4 text-sm text-white-1000 rounded-lg bg-red-400 dark:bg-gray-800 dark:text-red-400"
          role="alert"
        >
          <svg
          ...
          <span className="font-medium">خطا!</span><br/> {error}
        </div>
      )}
