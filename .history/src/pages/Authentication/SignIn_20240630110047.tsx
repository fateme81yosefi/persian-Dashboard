...
const SignIn: React.FC = () => {
  ...
  return (
    <>
      {error && (
        <div
          className="flex posi justify-between items-center p-4 mb-4 text-sm text-white rounded-lg bg-red-400 dark:bg-gray-800 dark:text-red-400"
          role="alert"
        >
          <div><svg
          ...
          <span className="font-medium ml-10">خطا!  </span></div>
          {error}
        </div>
      )}
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mb-5">
                  ...
                  {loggedIn && (
                    <p style={{ color: 'green' }}>ورود با موفقیت انجام شد!</p>
                  )}
                </div>
              </form>
            </div>
